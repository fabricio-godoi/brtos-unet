...
#if PROCESSOR == COLDFIRE_V1
#define RFIF             TPM1C1SC_CH1F = 0  	// Limpa flag da interrup��o externa
#define RFINT_ENABLE     TPM1C1SC_CH1IE = 1     // habilita interrup��o externa
#define RFINT_DISABLE    TPM1C1SC_CH1IE = 0     // desabilita interrup��o externa
...
#define RFIF              xHWREG(PORTD_BASE+PORT_ISFR) |= xHWREG(PORTD_BASE+PORT_ISFR)  // Limpa flag da interrup��o externa
#define RFINT_ENABLE      GPIOPinIntEnable(GPIOD_BASE, GPIO_PIN_4, GPIO_FALLING_EDGE)   // habilita interrup��o externa
#define RFIINT_DISABLE    GPIOPinIntDisable(GPIOD_BASE, GPIO_PIN_4)  					// desabilita interrup��o externa
#define RFFLAG			  0
#define NEEDS_INIT_TIMER  0
#define RF_TPMSC          TPM1SC
#define RF_MOD            TPM1MOD
...
#if PROCESSOR == COLDFIRE_V1
#define SysCtlPeripheralEnable(x)
#define GPIOPinReset(a,b)
#define GPIOPinSet(a,b)
#define GPIOPinConfigure(a)
#define GPIOPadConfigSet(a,b,c)
#define xGPIODirModeSet(a,b,c)
#if !__GNUC__
...
#define	ACTIVITY_LED_CLOCK_INIT
