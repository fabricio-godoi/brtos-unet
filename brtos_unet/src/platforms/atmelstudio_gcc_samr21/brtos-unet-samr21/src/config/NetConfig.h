...
/* available radios */
#define NEIGHBOURHOOD_SIZE   				(16)

extern struct rf233_driver;
#define UNET_RADIO 							rf233_driver
...
#define SystemTaskPriority     		(INT8U)31
...
#define Terminal_Priority			(INT8U)30
...
/// Memory locations for network address and configurations
  ...
  #define MAC64_MEM_ADDRESS  0x0001F800
  #define PANID_INIT_VALUE   0x47,0x42
  #define MAC16_INIT_VALUE   0x12,0x34
  #define ROUTC_INIT_VALUE   0x00  
#endif
#else
#if (UNET_DEVICE_TYPE == PAN_COORDINATOR)
