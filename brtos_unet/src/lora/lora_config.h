...
// gcc commandline. Use this file instead.
...
// 16 microseg per tick
// LMIC requires ticks to be 15.5microseg - 100 microseg long
...
// (or any other Print object). This can be easy for debugging.
#include "printf_lib.h"
#define LMIC_PRINTF(...) printf_lib(__VA_ARGS__)
